...
export const TreeSelect = ({ data, getValue, defaultValue, placeholder, radioVal, error }: any) => {
        ...
        >
          {data.map((data: any) =>
            data.child || data.list_jenis_belanja ? (
              <TreeDropdown1 key={data.kode} children={data} getValue={getValue} radioVal={radioVal} />
            ) : (
              <li
