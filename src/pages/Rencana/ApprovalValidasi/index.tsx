...
function ApprovalValidasi() {
  const itemBreadcrumb = [
    ...
    { path: "/", breadcrumbName: "Approval dan Validasi Kegiatan Madrasah" },
  ...
  return (
    <div>
      <BreadCrumb
        ...
        title="Approval dan Validasi Kegiatan Madrasah"
      />
      <div className="m-5 p-5 bg-white shadow-md rounded">
        <div className="flex flex-row justify-end my-3">
          <div
            className="bg-green-500 p-3 rounded-md text-white cursor-pointer hover:bg-blue-700 flex items-center justify-center"
            onClick={() => {
      ...
      <CustomModal
        ...
        onApproveOrReject={onApproveOrReject}></CustomModal>
    </div>
  );
}
