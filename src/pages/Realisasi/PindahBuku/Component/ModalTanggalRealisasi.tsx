...
const ModalTanggalRealisasiPindahBuku = ({
  openModal,
  title,
  data,
  store,
  ...
  return (
    <Modal
      key="modalTanggalRealisasiPindahBuku"
      visible={openModal}
      ...
      <Form
        ...
        form={form}
        layout="vertical"
        key="formTanggalRealisasiPindahBuku"
        name="formTanggalRealisasiPindahBuku">
        <div className="grid grid-cols-1  md:items-center   grid-cols-2 gap-2 ">
          <div>
            <Form.Item
...
export default ModalTanggalRealisasiPindahBuku;
