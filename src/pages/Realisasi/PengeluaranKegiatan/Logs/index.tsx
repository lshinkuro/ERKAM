...
import { getRealisasiPengeluaranKegiatanLogs } from "../../../../services/v2/realizationservice/pengeluarankegiatanservices";

const LogPengeluaranKegiatan = () => {
  ...
  const getData = async () => {
    setLoading(true);
    const dataTmp = await getRealisasiPengeluaranKegiatanLogs(auth.isTahun);
    console.log(dataTmp);
  ...
  return (
    <>
      <BreadCrumb
        ...
        title="Log Pengeluaran Kegiatan"
        back={true}
        toBack={() => route.goBack()}
      />
...
export default LogPengeluaranKegiatan;
