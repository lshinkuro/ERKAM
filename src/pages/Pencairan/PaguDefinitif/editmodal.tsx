    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalBody>
        <div className="grid md:grid-cols-2 gap-2">
          <div className="my-2">NSM :{data.nsm}</div>
          <div className="my-2">Nama Madrasah :{data.nama_madrasah}</div>
          <div>
            <InputWithLabel
              label="Termin 1"
              inputOnChange={(e) => {
...
//   <Select {...props} className="mt-1" onChange={props.inputOnChange} {...props}>
